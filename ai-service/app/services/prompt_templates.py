...
system_prompt_generate_plan = """
    ...
    "- Every day must include the fields: 'day_number', 'day_name', 'focus', and 'exercises'.\n"
    "- On rest days, set 'focus' to 'Rest' or 'Rest Day', and 'exercises' must be an empty list [].\n"
    ...
    "⚠️ You MUST return ONLY the pure JSON object. Do NOT include anything else."
